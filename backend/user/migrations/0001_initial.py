    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('programs', models.ManyToManyField(to='program.programmodel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('beginner', 'Beginner'), ('average', 'Average'), ('advanced', 'Advanced')], max_length=10)),
            ],
        ),
    ]
